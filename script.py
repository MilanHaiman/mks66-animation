...
def first_pass( commands ):
    ...
    if varyQ and not framesQ:
      exit()
    if framesQ and not basenameQ:
      name = "default"
      print("name will be \"default\"")
...
def second_pass( commands, num_frames ):
    ...
    for command in commands:
      ...
      args = command['args']
      if c== 'vary':
        knob_name,start_index,end_index,start_value,end_value=command['knob'],int(args[0]),int(args[1]),args[2],args[3]
        for i in range(start_index,end_index+1):
          frames[i][knob_name]=(end_value-start_value)*(i-start_index)/(end_index-start_index) + start_value
